...
class CustomerController extends BaseController
{
    ...
    public function newExcerciceAction(Request $request, FiscalManager $fs)
    {
        ...
        return $this->render('excercice/new.html.twig', ['formexcercice' => $formexcercice->createView()]);
    }
    ...
    public function listExcericeAction(Customer $company, Request $request)
    {
        ...
        return $this->render('excercice/list.html.twig', ['excercices' => $excercices, 'delete_form' => $listexcercice]);
    }
    ...
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('excercice_delete', ['id' => $fiscalYear->getId()]))
            ->setMethod('DELETE')
            ->getForm()
            ;
    }
